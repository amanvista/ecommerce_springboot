...
public class CartItemController {
    ...
    public ResponseEntity<CartResponse> updateCartItem(@PathVariable Long cartItemId, @RequestBody CartItem updatedCartItem,@RequestHeader("Authorization") String jwt)throws UserException, CartItemException{
...
//        CartItem cartItem = cartItemService.findCartItemById(cartItemId);
    ...
    public ResponseEntity<CartResponse> deleteCartItem(@PathVariable Long cartItemId, @RequestHeader("Authorization") String jwt)throws UserException, CartItemException {
        User user = userService.findUserProfileByJwt(jwt);
