...
//            @RequestParam(required = false) String category,
        ...
        Page<Product> res = productService.getAllProduct(color,size,minPrice,maxPrice,minDiscount,sort,stock,pageNumber,pageSize);
...
//        product.setCategory(category);
    ...
    public ResponseEntity<Product> updateProductById(@PathVariable Long productId, @RequestBody CreateProductRequest createProductRequest)throws ProductException{
