...
public class AuthController {
    ...
    @Autowired
    public AuthController(UserRepository userRepository, JwtProvider jwtProvider, PasswordEncoder passwordEncoder, UserServiceImpl userServiceImpl) {
...
//        SecurityContextHolder.getContext().setAuthentication(authentication);
    ...
    @PostMapping("/signin")
    public ResponseEntity<AuthResponse> loginUserHandler(@Valid @RequestBody LoginRequest loginRequest)throws UserException {
